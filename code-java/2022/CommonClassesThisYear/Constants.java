...
public class Constants {
    ...
    public static final int BOTTOM_LIMIT_SWITCH_ID = 10; //TBD
    ...
    //climb constants
    public static final int WINCH_MOTOR_CHANNEL_L = 6;
    public static final int WINCH_MOTOR_CHANNEL_R = 5;
    ...
    public static final double STARTING_ANGLE_PULSES = (STARTING_ANGLE / 360) * PIVOT_GEAR_RATIO * PULSES_PER_REVOLUTION;
    public static final double SHOOTER_ANGLE_PULSES = (SHOOTER_ANGLE / 360) * PIVOT_GEAR_RATIO * PULSES_PER_REVOLUTION;
    public static final double CLIMB_ANGLE_PULSES = (CLIMB_ANGLE / 360) * PIVOT_GEAR_RATIO * PULSES_PER_REVOLUTION;
}