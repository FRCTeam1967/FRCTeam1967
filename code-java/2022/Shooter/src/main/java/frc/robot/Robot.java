...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    SmartDashboard.putNumber("Bottom Roller Setpoint", -4000);
    SmartDashboard.putNumber("Top Roller Setpoint", 4000);
    SmartDashboard.putNumber("Bottom Roller Encoder Value", shooter.bottomMotorEncoder.getVelocity());
    SmartDashboard.putNumber("Top Roller Encoder Value", shooter.topMotorEncoder.getVelocity());
