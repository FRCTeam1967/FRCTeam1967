...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    //   m_led.setFlashColors(Color.kBlack, Color.kPurple, 0.1);
    
    // } else if (xboxController.GetButtonB()){
    //   m_led.setChasingColors(Color.kDarkGreen, Color.kDarkSlateBlue, 10, 0.001);
    // }

    m_led.wakeupSequence();
