...
public class LEDPanel {
    ...
    // Set pixels to display the given image (or what fits) at a given alpha
    public void setImage(BufferedImage image, double alpha) {
        // Image doesn't let us extract HSV values, so the strategy is to transform
        // the image into a new one with the alpha applied, and then draw that to the
        // screen.
