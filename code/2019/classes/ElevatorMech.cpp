...
#define ROCKET_LOW_CARGO_HEIGHT 22.5 - INCHES_OFF_GROUND 
#define ROCKET_MED_CARGO_HEIGHT 48.5 - INCHES_OFF_GROUND 
#define ROCKET_HIGH_CARGO_HEIGHT 79.0 - INCHES_OFF_GROUND 
#define ROCKET_LOW_HATCH_HEIGHT 2.0 + GROUND_HEIGHT
#define ROCKET_MED_HATCH_HEIGHT 38 - INCHES_OFF_GROUND 
#define ROCKET_HIGH_HATCH_HEIGHT 64.5 - INCHES_OFF_GROUND 
