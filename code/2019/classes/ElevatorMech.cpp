...
#define ROCKET_LOW_CARGO_HEIGHT 29.5 - INCHES_OFF_GROUND 
#define ROCKET_MED_CARGO_HEIGHT 55.5 - INCHES_OFF_GROUND 
#define ROCKET_HIGH_CARGO_HEIGHT 88.0 - INCHES_OFF_GROUND 
#define ROCKET_LOW_HATCH_HEIGHT 19.0 + GROUND_HEIGHT
#define ROCKET_MED_HATCH_HEIGHT 48 - INCHES_OFF_GROUND 
#define ROCKET_HIGH_HATCH_HEIGHT 88.0 - INCHES_OFF_GROUND 
#define HP_HEIGHT 15 - INCHES_OFF_GROUND 
#define CARGO_SHIP_CARGO_HEIGHT 43 - INCHES_OFF_GROUND  // one inch over edge of bay
