...
#define ROLLER_SPEED_FORWARD 0.6
...
public:
	...
	//Member Variables
	frc::DigitalInput*lSwitchTop;
	frc::DigitalInput*lSwitchDown;
	frc::DigitalInput*lSwitchMid;
	//DigitalInput*toteIn;
	...
	frc::Talon*motorLift;
	frc::Talon*motorRoller1;
	frc::Talon*motorRoller2;
	frc::Solenoid*brake;
	frc::Solenoid*rollerPistons;
	frc::Solenoid*reorientation;
	frc::Solenoid*singulationOne;
	frc::Solenoid*singulationTwo;
	frc::Timer*preRollerTimer;
	frc::Timer*rollerInTimer;
	frc::Timer*rollerOutTimer;
};
