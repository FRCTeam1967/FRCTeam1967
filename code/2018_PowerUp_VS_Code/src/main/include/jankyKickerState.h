...
public:
	...
	frc::Solenoid * dogGearPistonOne;
	frc::Solenoid * dogGearPistonTwo;
	frc::Solenoid * pawlPistonOne;
	frc::Solenoid * pawlPistonTwo;
	WPI_TalonSRX * pWindMotor;
	frc::Timer * dogGearTimer;
	frc::Timer * postWindUpTimer;
	frc::Timer * pawlTimer;
	frc::Timer * addWindTimer;
