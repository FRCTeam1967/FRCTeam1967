...
void UpAndDown::SmartDashboardComments() {
	...
	frc::SmartDashboard::PutBoolean("Limit switch top value", GetTopLimSwitch());
	frc::SmartDashboard::PutBoolean("Limit switch bottom value", GetBottomLimSwitch());
	frc::SmartDashboard::PutNumber("Encoder Dist:" ,GetGameMotorEncoderDistance());
