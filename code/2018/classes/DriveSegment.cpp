...
DriveSegment::DriveSegment(frc::ADXRS450_Gyro*gyro, frc::RobotDrive*drive, SensorCollection*leftEncoder, SensorCollection*rightEncoder, WPI_TalonSRX*leftmotor, WPI_TalonSRX*rightmotor, int inchDistance, double speed, double p, double i, double d, InAndOut*inAndOut) {
