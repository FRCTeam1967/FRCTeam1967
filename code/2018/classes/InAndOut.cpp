...
InAndOut::InAndOut(int pistonDoorLeftChannel, int pistonDoorRightChannel, int motorRollChannel, int motorClawChannel){
	pistonDoorLeft = new frc::Solenoid(10, pistonDoorLeftChannel);
	pistonDoorRight = new frc::Solenoid(10, pistonDoorRightChannel);
...
void InAndOut::Run() {
	...
	frc::SmartDashboard::PutNumber("InOut Encoder" , GetEncoderCount());
