...
void RobotMap::init() {
    ...
    driveTrainRightMotor.reset(new Jaguar(1));
    lw->AddActuator("DriveTrain", "Right Motor", (Jaguar&) driveTrainRightMotor);
    
    driveTrainLeftMotor.reset(new Jaguar(2));
    lw->AddActuator("DriveTrain", "Left Motor", (Jaguar&) driveTrainLeftMotor);
    
    driveTrainRobotDrive21.reset(new RobotDrive(driveTrainLeftMotor, driveTrainRightMotor));
    ...
    armMotor.reset(new Talon(0));
    lw->AddActuator("Arm", "Motor", (Talon&) armMotor);
    
    armPot.reset(new AnalogPotentiometer(0, 1.0, 0.0));
    lw->AddSensor("Arm", "Pot", armPot);
    
    ballIntakeMotor.reset(new Talon(5));
    lw->AddActuator("Ball Intake", "Motor", (Talon&) ballIntakeMotor);
