...
void GripPipeline::Process(cv::Mat & source0){
	...
	SmartDashboard::PutString("was it resized?", "yes");
	double hsvThresholdHue[] = {0.0, 180.0};
	double hsvThresholdSaturation[] = {0.0, 68.83701188455008};
	...
	SmartDashboard::PutString("hsv threshhold to source0?", "yes");
	bool findContoursExternalOnly = true;  // default Boolean
	findContours(findContoursInput, findContoursExternalOnly, this->findContoursOutput);
	SmartDashboard::PutString("found contours?", "yes");
	...
	SmartDashboard::PutString("filtered contours?", "yes");
	SmartDashboard::PutNumber("contour vector", filterContoursOutput.size());
}
